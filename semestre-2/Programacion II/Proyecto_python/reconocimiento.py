...
Galeria_face = "Proyecto_python/face"
facesEncodings = []
facesNames = []
for file_name in os.listdir(Galeria_face):
     image = cv2.imread(Galeria_face + "/" + file_name)
...
while True:
     ...
     orig = frame.copy()
     faces = face_id.detectMultiScale(frame, 1.1, 5)
