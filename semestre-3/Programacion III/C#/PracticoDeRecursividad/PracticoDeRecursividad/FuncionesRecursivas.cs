...
namespace PracticoDeRecursividad
{
    internal class FuncionesRecursivas
    {
        ...
        public static int SumarEVector(int[] vector, int indice = 0)
        {
            ...
            {
                return vector[indice] + SumarEVector(vector, indice + 1);
            }
        }

        //Ejercicio 3 Multiplicar los elementos de un vecotr
        public static int MultiplicarEVector(int[] vector, int indice = 0)
        {
            if (indice == vector.Length - 1)
            {
                return vector[indice];
            ...
            {
                return vector[indice] * MultiplicarEVector(vector, indice + 1);
            }
        }

        //Ejercicio 4 Mostrar menor elemento de un vector
        public static int MenorNVector(int[] vector, int indice = 0)
        {
            if (indice == vector.Length - 1)
            {
                return vector[indice];
            ...
            {
                int menorResto = MenorNVector(vector, indice + 1);
        ...
        public int mayorNVector(int[] numeros, int nLongitud)
        {
            if (nLongitud == 1)
            {
                return numeros[0];
            ...
            else
            {
                ...
                Array.Copy(numeros, 0, primeraMitadNumeros, 0, mitadNLongitud);
                Array.Copy(numeros, mitadNLongitud, segundaMitadNumeroes, 0, nLongitud - mitadNLongitud);

                int mayorPrimeraMitad = mayorNVector(primeraMitadNumeros, mitadNLongitud);
                int mayorSegundaMitad = mayorNVector(segundaMitadNumeroes, nLongitud - mitadNLongitud);
